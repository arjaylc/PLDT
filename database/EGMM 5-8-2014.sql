...
--
-- Table structure for table `node_pms_ assignments`
--

DROP TABLE IF EXISTS `node_pms_ assignments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `node_pms_ assignments` (
  `nodeName` varchar(64) NOT NULL,
  `idNo` int(11) NOT NULL,
  `deadline` datetime NOT NULL,
  `date_accomplished` datetime DEFAULT NULL,
  PRIMARY KEY (`nodeName`),
  KEY `fk_user_idNo_idx` (`idNo`),
  CONSTRAINT `fk_user_idNo` FOREIGN KEY (`idNo`) REFERENCES `users` (`idNo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pms_nodeName` FOREIGN KEY (`nodeName`) REFERENCES `node` (`nodeName`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node_pms_ assignments`
--

LOCK TABLES `node_pms_ assignments` WRITE;
/*!40000 ALTER TABLE `node_pms_ assignments` DISABLE KEYS */;
/*!40000 ALTER TABLE `node_pms_ assignments` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-08  9:42:21

<?php
	...
	$nodeName = $database_master->escapeString($nodeName);
	$query = "UPDATE node SET nodeName='$nodeName', sinNo='$sinNumber', electricMeterNo='$ElectricMeterNo', node_type='$node_type', cabinetNo='$cabinetNo', central_officeName='$office', nodeLocation='$nodeLocation'
